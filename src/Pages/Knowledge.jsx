...
const Knowledge = () => {
    return (
        ...
        <div className="w-full mx-auto space-y-4 text-center">
            ...
            <h1 className="text-4xl font-bold leading-tight md:text-5xl">What Are the Benefits of Reading Books?</h1>
        ...
        <div className="dark:text-gray-800">
            <p>Here are 10 benefits of reading that illustrate the importance of reading books. When you read every day you:</p>
        </div>
        <div className="pt-12 border-t dark:border-gray-300">
            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="dark:text-gray-600">Gain valuable knowledge
<p>Exercise your brain</p>
<p>Improve your focus</p>
<p>Improve your memory</p>
<p>Enjoy entertainment</p>
<p>Improve your ability to empathize</p>
